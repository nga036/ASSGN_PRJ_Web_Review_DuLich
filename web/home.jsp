        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-w
                     hite">
                    <h1 class="display-4 fw-bolder" style="color: pink">Review Tourist Places</h1>
                ...
                <div class="row">
                    <div class="col-md-3 mb-5">
                        ...
                        <ul class="list-group category_block">
                            <!-- Duyệt qua danh sách các danh mục và hiển thị -->
                            <c:forEach items="${listCategories}" var="C">

                                <li class="list-group-item text-white ${tag == C.cid? "active":""}">
                                    <!-- Liên kết đến trang danh mục cụ thể -->
                    ...
                    <div class="col-md-9">
                        ...
                        <!-- Kiểm tra nếu danh sách sản phẩm không có hoặc rỗng -->
                        <c:choose>
