...
//        // Kiểm tra xem có thông báo lỗi từ servlet AddProductController không
//        String error = request.getParameter("error");
//        if (error != null && error.equals("empty")) {
//            // Nếu có thông báo lỗi, truyền thông báo lỗi cho trang ManagerProduct.jsp và hiển thị lại trang này
//            request.setAttribute("mess", "not is empty");
